...
export default function Home() {
  return <main className={styles.page}>
    ...
    <section className={styles.profile} id="profil"><p className={styles.label}>01 — Profil Profesional</p><div className={styles.profileGrid}><h2>Teknologi yang memperkuat peran pendidik.</h2><div><p>Dr. Ade Irfansyah merupakan dosen, praktisi, trainer, dan konsultan transformasi pendidikan berbasis AI dengan pengalaman dalam media pembelajaran digital, asesmen berbasis teknologi, presentasi profesional, dan otomatisasi pembelajaran.</p><p>Dengan latar belakang Teknik Elektro, Teknik Penerbangan, dan Pendidikan Vokasi, beliau mengintegrasikan teknologi, pendidikan, dan inovasi digital untuk membantu pendidik serta institusi menghadapi perubahan secara percaya diri.</p></div></div><blockquote>“Teknologi bukan untuk menggantikan pendidik, tetapi untuk memperkuat peran pendidik dalam menciptakan pembelajaran yang lebih bermakna.”</blockquote></section>
    ...
    <footer className={styles.footer}><b>Dr. Ade Irfansyah</b><span>Transformasi Pendidikan Berbasis AI</span><span>© 2026</span></footer>
  </main>;
}
